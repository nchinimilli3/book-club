...
- `user_preferences` — active club + notification mode
...
- `ballots`, `nominations`, `votes` — hidden single-choice voting
...
- `personal_books`, `goodreads_imports` — personal library and import history
...
Production realtime publication includes posts, replies, reactions, reading progress, meeting RSVPs, meetings, meeting agenda items, club books, ratings, ballots and notifications.
